...
export declare function compileGeneralSelector<Node, ElementNode extends Node>(next: Compileimport type { CompiledQuery, InternalOptions, InternalSelector, CompileToken } from "./types.js";
